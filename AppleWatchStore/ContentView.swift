...
//  AppleWatchStore
//
//  Created by Susan Kim on 2021/08/31.
//
...
struct ContentView: View {
    ...
    var body: some View {
        ...
        ZStack {
            ...
            // hiding main view when ddetail view is visible...
...
struct CShape: Shape {
    ...
    func path(in rect: CGRect) -> Path {
        ...
        let path = UIBezierPath(roundedRect: rect, byRoundingCorners: [.topLeft, .topRight], cornerRadii: .init(width: 45, height: 45))
        ...
        ZStack {
            ...
            VStack {
                ...
                HStack(spacing: 15) {
                    ...
                    TextField("Watn to search anything", text: self.$txt)
                }
                .padding()
                .background(Color.white)
                .cornerRadius(8)
                ...
                // zindex sets views position on the stack...
